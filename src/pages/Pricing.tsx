    ...
    <main className="pt-32 pb-24 px-6 md:px-12 lg:px-24">
      ...
      <div className="flex justify-center mb-16">
        <div className="bg-surface-container-highest p-1 rounded-full flex items-center">
          <button className="px-8 py-3 rounded-full bg-primary text-on-primary font-bold text-sm transition-all">Monthly</button>
          <button className="px-8 py-3 rounded-full text-on-surface-variant font-medium text-sm hover:text-white transition-all">Yearly (-20%)</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
        ...
        <div className="bg-surface-container rounded-xl p-8 flex flex-col magnetic-hover">
          <div className="mb-8">
            <span className="material-symbols-outlined text-primary text-3xl mb-4" data-icon="web">web</span>
          ...
          <button className="w-full py-4 border border-outline-variant rounded-full text-sm font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-all">Choose CMS</button>
        </div>
        ...
        <div className="relative bg-surface-container-highest rounded-xl p-8 flex flex-col magnetic-hover ring-2 ring-secondary shadow-[0_0_60px_rgba(193,128,255,0.15)]">
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-secondary text-on-secondary px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">Most Popular</div>
          <div className="mb-8">
            <span className="material-symbols-outlined text-secondary text-3xl mb-4" data-icon="code_blocks">code_blocks</span>
          ...
          <ul className="space-y-4 mb-10 flex-grow">
            <li className="flex items-center gap-3 text-sm font-medium">
              <span className="material-symbols-outlined text-secondary text-lg" data-icon="check_circle" data-weight="fill" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span>
          ...
          <button className="w-full py-4 bg-secondary text-on-secondary rounded-full text-sm font-bold uppercase tracking-wider shadow-lg shadow-secondary/20 hover:scale-105 transition-all">Start Building</button>
        </div>
        
        {/* Mobile App Tier */}
        <div className="bg-surface-container rounded-xl p-8 flex flex-col magnetic-hover">
          <div className="mb-8">
            <span className="material-symbols-outlined text-primary text-3xl mb-4" data-icon="smartphone">smartphone</span>
          ...
          <button className="w-full py-4 border border-outline-variant rounded-full text-sm font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-all">Go Mobile</button>
        </div>
        ...
        <div className="bg-surface-container-low rounded-xl p-8 flex flex-col magnetic-hover border border-outline-variant/20">
          <div className="mb-8">
            <span className="material-symbols-outlined text-tertiary text-3xl mb-4" data-icon="language">language</span>
            <h3 className="font-headline text-2xl font-bold mb-2">Global</h3>
            <p className="text-on-surface-variant text-sm">Multi-region architecture for global firms.</p>
          </div>
          <div className="mb-8">
            <span className="text-4xl font-extrabold">Custom</span>
            <span className="text-on-surface-variant text-sm">/quote</span>
          </div>
          <ul className="space-y-4 mb-10 flex-grow">
            <li className="flex items-center gap-3 text-sm">
          ...
          <button className="w-full py-4 bg-tertiary text-on-tertiary-container rounded-full text-sm font-bold uppercase tracking-wider hover:brightness-110 transition-all">Talk to Sales</button>
        </div>
      </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-12 bg-surface-container-low rounded-xl p-12 mb-24 items-center">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-on-surface-variant text-sm">Enterprise-grade encryption and global processing via Stripe.</p>
        </div>
        <div className="flex flex-col items-center text-center border-y md:border-y-0 md:border-x border-outline-variant/30 py-12 md:py-0 px-6">
          <div className="w-16 h-16 rounded-full bg-secondary-container/20 flex items-center justify-center mb-6">
            <span className="material-symbols-outlined text-secondary text-3xl" data-icon="speed">speed</span>
          </div>
          <h4 className="font-headline text-xl font-bold mb-2">Performance Guarantee</h4>
          <p className="text-on-surface-variant text-sm">Sub-second load times and 99.9% uptime for every project.</p>
        </div>
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-on-surface-variant text-sm">Direct Slack channel and monthly strategy calls included.</p>
        </div>
      </section>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="text-sm">
              <tr className="border-b border-outline-variant/10">
                ...
                <td className="py-6"><span className="material-symbols-outlined text-primary" data-icon="check">check</span></td>
                <td className="py-6"><span className="material-symbols-outlined text-secondary" data-icon="check">check</span></td>
                <td className="py-6"><span className="material-symbols-outlined text-primary" data-icon="check">check</span></td>
                <td className="py-6"><span className="material-symbols-outlined text-primary" data-icon="check">check</span></td>
              </tr>
              <tr className="border-b border-outline-variant/10">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-dim/20 to-secondary-dim/20 rounded-xl p-12 md:p-24 text-center border border-outline-variant/20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
          ...
          <button className="bg-transparent border border-white/20 text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-white/10 transition-all">Schedule Demo</button>
        </div>
      </div>
    </main>
  );
